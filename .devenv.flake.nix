{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/ta/src/courses/bootdev/bootdev-ssg";
  project_input_ref = "path:/home/ta/src/courses/bootdev/bootdev-ssg";
  devenv_dotfile = "/home/ta/src/courses/bootdev/bootdev-ssg/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-28fa6be";
  ...
  hostname = "ghost";
  username = "ta";
  git_root = "/home/ta/src/courses/bootdev/bootdev-ssg";
  secretspec = null;
};
    in
    {
